...
export default function Header() {
  ...
  return (
    <div className="container mx-auto">
              ...
              <NavigationMenuItem>
                ...
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                    <li className="row-span-5 lg:row-span-4">
      ...
      {isMenuOpen && (
        <>
         <div className="menu-open fixed inset-0 z-[-50] bg-black bg-opacity-50">
         <div className="fixed top-28 left-0 bottom-0 w-64  shadow-lg transform transition-transform duration-800 ease-in-out">
         <NavigationMenu>
